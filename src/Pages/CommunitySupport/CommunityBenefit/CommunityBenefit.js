    ...
    return (
        <div className={` ${styles.paddingY} relative text-white`}>
            <div className='font-poppins'>
                <h1 className='text-4xl font-bold text-center'>Find your dream job in a well-known company and make a career with our platform</h1>
                <p className='w-2/3 mx-auto text-center mt-3'>Our community platform brings together many popular companies in recruting talents and people with passion for developement.</p>
            </div>
            <div className='grid grid-cols-3 gap-4 font-poppins mt-8'>
                <div className='bg-cyan-900 p-4'>
                    ...
                    <p>The platform focuses on run code & save them. Developers from around the world can use our website without any hassle.</p>
                </div>
