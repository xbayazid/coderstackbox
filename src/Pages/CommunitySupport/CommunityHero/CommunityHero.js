...
const CommunityHero = () => {
    return (
        <div  className={` ${styles.paddingY} relative`}>
           ...
           <h1 className='text-7xl font-bold'><span className='text-accent'>Commun</span>ity</h1>
           <p className='my-4 w-2/4'>The worlds first and largest coding community platform here to connect people in the world</p>
           <div>
            <img src={heroImg} alt="" />
           </div>
