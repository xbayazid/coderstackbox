        ...
        <div>
            <div className='flex text-white font-poppins'>
                ...
                <div className='bg-gray-700 p-5'>
                    ...
                    <div>
                        <div className='my-4'>
                            <h5 className='text-2xl'><span className='text-orange-200'>01</span><span className='mx-3 font-bold'>Be the best</span></h5>
                            <p className='my-3 w-3/3'>We have trusted by many big companies in the world. We have millions of users.</p>
                            <hr />
                        </div>
                        <div className='my-4'>
                            <h5 className='text-2xl'><span className='text-orange-200'>02</span><span className='mx-3 font-bold'>Be the largest platform</span></h5>
                            <p className='my-3'>We have trusted by many big companies in the world. We have millions of users.</p>
                            <hr />
                        </div>
                        <div className='my-4'>
                            <h5 className='text-2xl'><span className='text-orange-200'>03</span><span className='mx-3 font-bold'>Make impact</span></h5>
                            <p className='my-3'>We have trusted by many big companies in the world. We have millions of users.</p>
                            <hr />
                        </div>
                    </div>
