    ...
    <div>
      ...
      <div className="text-white">
        <div className="main-content w-full">
          <h2 className="text-3xl mb-5 others text-gray-800">
            Hello, Wellcome back!
          </h2>
                  ...
                  <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                      <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4">News Portal</td>
                      ...
                      <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4">Movie Server</td>
                        <td class="px-6 py-4">Rahim Mia</td>
                      </tr>
                      <tr class="bg-white dark:bg-gray-800">
                        ...
                        <td class="px-6 py-4">Online Code Editor</td>
                        <td class="px-6 py-4">Katrina Kaif</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
