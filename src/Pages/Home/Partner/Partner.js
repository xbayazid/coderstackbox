        ...
        <div className={`${layout.sectionReverse}`}>
          <div className={`${layout.sectionImg}`}>
            <div className="flex flex-col gap-3">
              <motion.div
                variants={planetVariants("left", "spring", 0.5, 1)}
                className=" bg-sky-300 w-1/2 rounded-full"
              >
                <img src={partnerTwo} alt="" />
              </motion.div>
              <motion.div
                variants={planetVariants("left", "spring", 0.3, 2)}
                className="-mr-20 bg-slate-700 w-3/2 rounded-full"
              >
                <img src={partnerOne} alt="" />
              </motion.div>
              <motion.div
                variants={planetVariants("left", "spring", 0.6, 2)}
                className=" bg-gray-300 w-1/2 rounded-full"
              >
            ...
            <div className="flex flex-col gap-3">
              <motion.div
                variants={planetVariants("left", "spring", 0.7, 2)}
                className="bg-violet-500 w-1/2 rounded-full"
              >
                <img src={partnerFour} alt="" />
              </motion.div>
              <motion.div
                variants={planetVariants("left", "spring", 1, 2)}
                className="bg-fuchsia-300 w-1/2 rounded-full"
              >
          ...
          >
            ...
            <p className="my-5 lg:text-justify text-white">
              ...
              carefully chosen these partners based on their expertise in the
              coding industry, and our shared commitment to innovation and
              excellence. Tus
            </p>
