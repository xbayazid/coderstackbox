            ...
            <div className='grid grid-cols-1 lg:grid-cols-3 gap-4 md:grid-cols-2 mt-10'>
                <div className=' border border-lime-500 rounded-md mt-10'>
                    <div className="card-body">
                        ...
                        <p className="text-center mt-10">The only way to learn to program is by writing code. That's why we provides HTML, CSS and Javascript compiler section that you can edit and run your code by yourself. Also user can debug error in code.</p>
                    </div>
