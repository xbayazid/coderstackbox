...
const Services = () => {
    return (
        ...
        <div>
            <h1 className="text-3xl lg:text-6xl text-white text-center font-semibold lg:font-bold">Codestack is a platform that allows you to build, run, and share</h1>
            <div id='service' className={`${layout.sectionCol} text-white`}>
            <div className='grid grid-cols-1 lg:grid-cols-2'>
                <div className='font-poppins'>
                    <div className='w-3/4'>
                    <h1 className='text-2xl lg:text-5xl font-semibold'>We Are Focus On Your Ultimate Goal</h1>
                    <p className='mt-4'>Codestack is a platform that allows you to build, run, and share code in three different programming languages HTMl, CSS and JAVASCRIPT.</p> 
                    </div>
                   <div className='text-2xl mt-5'>
                    <div className='bg-sky-400 p-4 lg:w-1/2 text-center flex items-center rounded-md'>
                       <TiLightbulb className='ml-2 mr-2 bg-purple-300 p-2 text-5xl rounded-full'></TiLightbulb> <h1>Build & Test</h1>
                    </div>
                    <div className='bg-sky-400 p-4 lg:w-1/2 text-center mt-4 flex items-center rounded-md'>
                      <TiEdit className='ml-2 mr-2 bg-purple-300 p-2 text-5xl rounded-full'></TiEdit>  <h1>Learn & Discover</h1>
                    </div>
                    <div className='bg-sky-400 p-4 lg:w-1/2 text-center mt-4 flex items-center rounded-md'>
                       <HiOutlineShare className='ml-2 mr-2 bg-purple-300 p-2 text-5xl rounded-full'></HiOutlineShare> <h1>Share Your Work</h1>
                    </div>
                   </div>
                </div>
