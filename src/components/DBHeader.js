      ...
      <div class="flex items-center justify-between space-x-4 px-6 2xl:container">
        ...
        <div class="flex space-x-4">
          ...
          <div hidden class="md:block">
            <div class="relative flex items-center text-gray-400 focus-secondary">
              ...
              <input
                ...
                class="outline-none w-full rounded-xl border border-gray-300 py-2.5 pl-14 pr-4 text-sm text-gray-600 transition focus:border-secondary dark:bg-gray-900 dark:border-gray-700"
              />
            </div>
          </div>
          {/*  <!--/search bar --> */}
